...
const Header = ({bgImage, title}: HeaderProps) => {
  return (
    <header className="relative w-full my-10 pb-50 text-white">
      <div className="inset-0 bg-black/5 opacity-40 fixed z-[-1]">
        <Image
          src={bgImage}
          className=""
      ...
      <div className="relative z-10 flex justify-between items-center mx-[10%]">
        <Image
          className="w-40 contrast-200"
          src={logo}
          alt="logo"
        />
        <nav className="h-10">
